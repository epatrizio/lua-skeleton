...
describe("factorial tests with busted framework", function ()
    describe("lua module", function ()
        it("check lib version", function ()
            assert.are.equal(factorial._VERSION, "1.1")
        end)
        ...
        it("CPS implementation", function ()
            assert.are.equal(factorial.fact_cont(0), 1)
            assert.are.equal(factorial.fact_cont(1), 1)
            assert.are.equal(factorial.fact_cont(5), 120)
        end)
        it("coroutine implementation", function ()
            assert.are.equal(factorial.fact_co(0), 1)
            assert.are.equal(factorial.fact_co(1), 1)
            assert.are.equal(factorial.fact_co(5), 120)
        end)
        it("equality between different implementations", function ()
            assert.are.equal(factorial.fact_imp(10), factorial.fact_rec(10))
            assert.are.equal(factorial.fact_imp(10), factorial.fact_cont(10))
            assert.are.equal(factorial.fact_cont(10), factorial.fact_rec(10))
            assert.are.equal(factorial.fact_co(10), factorial.fact_imp(10))
            assert.are.equal(factorial.fact_co(10), factorial.fact_rec(10))
            assert.are.equal(factorial.fact_co(10), factorial.fact_cont(10))
        end)
        it("check raising errors", function ()
            assert.has.errors(function () factorial.fact_imp(-42) end)
            assert.has.errors(function () factorial.fact_imp("incorrect") end)
            assert.has.errors(function () factorial.fact_imp(false) end)
            assert.has.errors(function () factorial.fact_rec(-42) end)
            assert.has.errors(function () factorial.fact_rec("incorrect") end)
            assert.has.errors(function () factorial.fact_rec(false) end)
        end)
    end)
    describe("c module", function ()
        it("check lib version", function ()
            assert.are.equal(factorial_c._VERSION, "1.0")
        end)
        it("imperative implementation", function ()
