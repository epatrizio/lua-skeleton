...
io.write("Coroutine factorial implementation ... ")
assert(factorial.fact_co(0) == 1)
assert(factorial.fact_co(1) == 1)
assert(factorial.fact_co(5) == 120)
print("Ok")
...
assert(factorial.fact_co(10) == factorial.fact_imp(10), "ko!")
assert(factorial.fact_co(10) == factorial.fact_rec(10), "ko!")
assert(factorial.fact_co(10) == factorial.fact_cont(10), "ko!")
print("Ok")
